...
<div class="confirm">
	<div class="description">
		...
		<div class="buttons">
			...
			<a class="btn btn-default btn-transparent-bg" href="<?=SITE_DIR;?>"><?=GetMessage('T_HEAD_LINK_MAIN');?></a>
		</div>
	</div>
</div>
<script>
...
$(document).ready(function(){
	<?if(!isset($_SESSION['ORDERS'][$_REQUEST['RESULT_ID']])):?>
		if(arAllcorp2Options['THEME']['YA_GOLAS'] == 'Y' && arAllcorp2Options['THEME']['YA_COUNTER_ID'] && arAllcorp2Options['THEME']['USE_SALE_GOALS'] !== 'N')
		{
