...
<?=CAdminMessage::ShowNote(GetMessage('ALLCORP2_MOD_INST_OK'));?>
<?=BeginNote('align="left"');?>
<?=GetMessage('ALLCORP2_MOD_INST_NOTE')?>
<?=EndNote();?>
<form action="/bitrix/admin/wizard_list.php?lang=ru">
	<input type="submit" name="" value="<?=GetMessage('ALLCORP2_OPEN_WIZARDS_LIST')?>">
<form>