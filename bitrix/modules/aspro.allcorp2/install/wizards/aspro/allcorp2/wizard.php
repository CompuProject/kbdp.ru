...
<?include_once($_SERVER["DOCUMENT_ROOT"]."/bitrix/wizards/aspro/allcorp2/css/styles.css");?>
<script>
	<?require_once($_SERVER['DOCUMENT_ROOT']."/bitrix/wizards/aspro/allcorp2/js/jquery-1.8.3.min.js");?>
	<?require_once($_SERVER['DOCUMENT_ROOT']."/bitrix/wizards/aspro/allcorp2/js/jquery.keyboard.js");?>
...
class SelectTemplateStep extends CSelectTemplateWizardStep{
	function InitStep(){
		...
		$wizard->SetDefaultVars(Array("templateID" => "allcorp2"));
	}
...
class SelectThemeStep extends CSelectThemeWizardStep{
	...
	function ShowStep(){
		...
		$arCurSiteTheme = CAllcorp2::GetBackParametrsValues($siteID);
...
class DataInstallStep extends CDataInstallWizardStep{
	...
	function CorrectServices(&$arServices){
		if($_SESSION["BX_allcorp2_LOCATION"] == "Y") $this->repeatCurrentService = true;
...
class FinishStep extends CFinishWizardStep{
	...
	function ShowStep(){
		...
		if(CModule::IncludeModule("aspro.allcorp2")) {
			CAllcorp2::sendAsproBIAction("wizard_installed");
		}

		COption::SetOptionString("aspro.allcorp2", "WIZARD_DEMO_INSTALLED", "Y");
	}
}
?>