...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'NAME,PROPERTY_'.$arProperty["PRICE"].',PROPERTY_'.$arProperty["FILTER_PRICE"].',ACTIVE,SORT,TIMESTAMP_X,ID', 'by' => 'timestamp_x', 'order' => 'desc', 'page_size' => '20',
	));
}
