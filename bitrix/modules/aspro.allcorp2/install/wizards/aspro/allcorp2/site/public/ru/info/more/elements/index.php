...
<div class="row">
	...
	<div class="col-md-6">
		...
		<ul class="pagination">
			<li class="prev"><a href="javascript:void(0)"><i class="svg inline  svg-inline-cabinet" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="9" height="15" viewBox="0 0 9 15">
  <defs>
    <style>
      .cls-1 {
        fill: #222;
  ...
  <path id="Left" class="cls-1" d="M7.027,14.611a1.009,1.009,0,0,0,1.591,0,0.936,0.936,0,0,0-.035-1.555L3.077,7.481,8.583,1.9A0.936,0.936,0,0,0,8.618.349a1.007,1.007,0,0,0-1.591,0L0.674,6.7a0.941,0.941,0,0,0-.354.778,0.945,0.945,0,0,0,.354.778Z"></path>
</svg>
</i></a></li>
			<li class="active"><span>1</span></li>
			<li><a href="javascript:void(0)">2</a></li>
			<li><a href="javascript:void(0)">3</a></li>
			<li class="next"><a href="javascript:void(0)"><i class="svg inline  svg-inline-cabinet" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" width="9" height="15" viewBox="0 0 9 15">
			  <defs>
			    <style>
			      .cls-1 {
			        fill: #222;
		...
		<span class="more_text_ajax loading">
		...
		<table class="order-block">
			<tr class="row1">
				<td class="col-md-9 col-sm-8 col-xs-7 valign1">
					<div class="text"><?=CAllcorp2::showIconSvg('order colored', SITE_TEMPLATE_PATH.'/images/svg/Order_service_lg.svg');?>Произвольный текст.<br />Красивее в две строки.</div>
				</td>
				<td class="col-md-3 col-sm-4 col-xs-5 valign1">
					<div class="btns">
						<span class="btn btn-default btn-lg" data-event="jqm" data-param-id="<?=CCache::$arIBlocks[SITE_ID]['aspro_allcorp2_form']['aspro_allcorp2_example'][0]?>" data-name="example" data-autoload-STRING="Автозаполнение строки">Пример формы</span>
					</div>
				</td>
			</tr>
		</table>
...
<div class="row">
	<div class="col-md-6">
		...
		<div class="flexslider front navigation-vcenter hover inside" data-plugin-options='{"animation":"slide", "animationLoop": true, "maxItems": 1}'>
			<ul class="slides">
				<li>
					<img alt="" class="img-responsive" src="#SITE_DIR#images/inner1.jpg">
				</li>
				<li>
					<img alt="" class="img-responsive" src="#SITE_DIR#images/inner2.jpg">
				</li>
				<li>
					<img alt="" class="img-responsive" src="#SITE_DIR#images/inner3.jpg">
				</li>
			</ul>
		</div>
	</div>
	<div class="col-md-6">
		...
		<div class="item zomm_wrapper-block">
			...
			<a class="dark_block_animate fancybox" data-plugin-options='{"type":"image"}' href="<?=SITE_TEMPLATE_PATH?>/images/project.jpg"></a>
		</div>
	</div>
</div>
<hr class="tall" />
