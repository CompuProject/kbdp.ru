...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_106").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_8").'--,--SORT--#--'.GetMessage("WZD_OPTION_14").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_12").'--,--edit1_csection1--#--'.GetMessage("WZD_OPTION_197").'--,--PROPERTY_'.$arProperty["LINK_REGION"].'--#--'.GetMessage("WZD_OPTION_326").'--,--PROPERTY_'.$arProperty["POSITION"].'--#--'.GetMessage("WZD_OPTION_198").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_199").'--,--PROPERTY_'.$arProperty["LINK"].'--#--'.GetMessage("WZD_OPTION_152").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_16").'--,--PROPERTY_'.$arProperty["TARGET"].'--#--'.GetMessage("WZD_OPTION_200").'--,--PROPERTY_'.$arProperty["SIZING"].'--#--'.GetMessage("WZD_OPTION_201").'--,--PROPERTY_'.$arProperty["SHOW_SECTION"].'--#--'.GetMessage("WZD_OPTION_202").'--,--PROPERTY_'.$arProperty["SHOW_PAGE"].'--#--'.GetMessage("WZD_OPTION_203").'--,--PROPERTY_'.$arProperty["HIDDEN_XS"].'--#--'.GetMessage("WZD_OPTION_204").'--,--PROPERTY_'.$arProperty["HIDDEN_SM"].'--#--'.GetMessage("WZD_OPTION_205").'--,--PROPERTY_'.$arProperty["BGCOLOR"].'--#--'.GetMessage("WZD_OPTION_206").'--,--edit1_csection2--#--'.GetMessage("WZD_OPTION_207").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_4").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_6").'--;--;--',
	));
	// list user options
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'NAME,PROPERTY_'.$arProperty["POSITION"].',PROPERTY_'.$arProperty["LINK_REGION"].',PREVIEW_PICTURE,ACTIVE,SORT,ID', 'by' => 'sort', 'order' => 'asc', 'page_size' => '20',
	));
}
