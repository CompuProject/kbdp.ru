	...
	<table class="order-block feed">
		<tr>
			<td class="col-md-9 col-sm-8 col-xs-7 valign">
				<div class="text">
					<?=CAllcorp2::showIconSvg('feed colored', SITE_TEMPLATE_PATH.'/images/svg/Feedback.svg');?>
					<?$APPLICATION->IncludeComponent('bitrix:main.include', '', Array('AREA_FILE_SHOW' => 'file', 'PATH' => SITE_DIR.'include/feedback.php', 'EDIT_TEMPLATE' => ''));?>
				</div>
			</td>
