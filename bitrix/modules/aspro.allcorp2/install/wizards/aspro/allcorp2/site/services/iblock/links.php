...
// iblocks ids
$servicesIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_content"]["aspro_allcorp2_services"][0];
$studyIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_catalog"]["aspro_allcorp2_study"][0];
$staffIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_content"]["aspro_allcorp2_staff"][0];
$reviewsIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_content"]["aspro_allcorp2_reviews"][0];
$projectsIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_content"]["aspro_allcorp2_projects"][0];
$catalogIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_catalog"]["aspro_allcorp2_catalog"][0];
$partnerIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_content"]["aspro_allcorp2_partners"][0];
$newsIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_content"]["aspro_allcorp2_news"][0];
$articlesIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_content"]["aspro_allcorp2_articles"][0];
$companyIBlockID = CCache::$arIBlocks[WIZARD_SITE_ID]["aspro_allcorp2_content"]["aspro_allcorp2_static"][0];
