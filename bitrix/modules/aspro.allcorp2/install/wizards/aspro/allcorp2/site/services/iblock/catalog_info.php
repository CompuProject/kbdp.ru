...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'NAME,DETAIL_PICTURE,ACTIVE,SORT,PROPERTY_'.$arProperty["FILTER_URL"].',PROPERTY_'.$arProperty["SECTION"].',PROPERTY_'.$arProperty["FORM_QUESTION"].',PROPERTY_'.$arProperty["LINK_REGION"].',ID', 'by' => 'timestamp_x', 'order' => 'desc', 'page_size' => '20',
	));
}
