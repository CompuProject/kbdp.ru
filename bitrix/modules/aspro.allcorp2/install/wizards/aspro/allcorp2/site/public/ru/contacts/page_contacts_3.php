...
<div itemscope itemtype="http://schema.org/Organization">
		...
		<div class="contacts-wrapper">
			<div class="row">
				<div class="<?=($bUseFeedback ? 'col-md-4' : 'col-md-6')?>">
					<?CAllcorp2::showContactAddr('Центральный офис');?>
				</div>
				<div class="<?=($bUseFeedback ? 'col-md-3' : 'col-md-3')?>">
					<?CAllcorp2::showContactPhones('Справочная служба');?>
				</div>
				<div class="<?=($bUseFeedback ? 'col-md-3' : 'col-md-3')?>">
				...
				<?if($bUseFeedback):?>
					<div class="col-md-2 b-block">
						<button data-event="jqm" data-param-id="<?=CAllcorp2::getFormID("aspro_allcorp2_question");?>" data-name="order_services" class="btn btn-default btn-transparent-bg btn-block"><span>Задать вопрос</span></button>
					</div>
				<?endif;?>
			</div>
		</div>
	...
	<div class="row">
		<div class="contacts maxwidth-theme desc">
