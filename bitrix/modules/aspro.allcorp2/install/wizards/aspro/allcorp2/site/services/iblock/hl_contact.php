...
unset($_SESSION["ALLCORP2_HBLOCK_CONTACT_ID"]);

$dbHblock = HL\HighloadBlockTable::getList(array("filter" => array("NAME" => "AsproAllcorp2ContactReference")));
if(!$dbHblock->Fetch()){
	$data = array('NAME' => 'AsproAllcorp2ContactReference', 'TABLE_NAME' => 'b_hlbd_sposobyoplaty');
	$result = HL\HighloadBlockTable::add($data);
	$HL_ID = $result->getId();
	$_SESSION["ALLCORP2_HBLOCK_CONTACT_ID"] = $HL_ID;
