...
$FORM_SID = "aspro_allcorp2_callback_".WIZARD_SITE_ID;
...
if($db_res = CEventType::GetList(array("TYPE_ID" => "FORM_FILLING_".$FORM_SID))){ 
	...
	if(!$count){
		...
		$arFields = array("LID" => $lang, "EVENT_NAME" => "FORM_FILLING_".$FORM_SID, "NAME" => GetMessage("EVENT_NEW_CALLBACK_NAME"), "DESCRIPTION" => GetMessage("EVENT_NEW_CALLBACK_DESCRIPTION"));
...
$by = "id"; $order = "asc";
$arFields = array("ACTIVE" => "Y", "EVENT_NAME" => "FORM_FILLING_".$FORM_SID, "LID" => WIZARD_SITE_ID, "EMAIL_FROM" => $wizard->GetVar("siteEmail"), "EMAIL_TO" => "#EMAIL_RAW#", "SUBJECT" => GetMessage("NEW_CALLBACK_EMAIL_SUBJECT"), "MESSAGE" => GetMessage("NEW_CALLBACK_EMAIL_TEXT"), "BODY_TYPE" => "html");
...
if($form_id){
	...
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("CALLBACK_FORM_QUESTION_1"), "TITLE_TYPE" => "text", "SID" => "NAME", "C_SORT" => 100, "ADDITIONAL" => "N", "REQUIRED" => "Y", "arANSWER" => $arANSWER);
