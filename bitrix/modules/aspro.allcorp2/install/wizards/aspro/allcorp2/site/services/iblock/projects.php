...
$iblockTYPE = "aspro_allcorp2_content";
...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID, "CODE" => "TOP_PICTURE"));
	if(!$dbProperty->SelectedRowsCount())
	{
		$ibp = new CIBlockProperty;
		$arFields = Array(
			"NAME" => GetMessage("WZD_OPTION_324"),
			"ACTIVE" => "Y",
			"SORT" => "100",
			"CODE" => "TOP_PICTURE",
			"PROPERTY_TYPE" => "F",
	...
	$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID, "CODE" => "MAP"));
	if(!$dbProperty->SelectedRowsCount())
	{
		$ibp = new CIBlockProperty;
		$arFields = Array(
	...
	$dbProperty = CIBlockProperty::GetList(array(), array("IBLOCK_ID" => $iblockID, "CODE" => "INFO"));
	if(!$dbProperty->SelectedRowsCount())
	{
		$ibp = new CIBlockProperty;
		$arFields = Array(
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_120").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--ACTIVE_FROM--#--'.GetMessage("WZD_OPTION_4").'--,--ACTIVE_TO--#--'.GetMessage("WZD_OPTION_6").'--,--NAME--#--'.GetMessage("WZD_OPTION_8").'--,--CODE--#--'.GetMessage("WZD_OPTION_10").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_12").'--,--SORT--#--'.GetMessage("WZD_OPTION_14").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_16").'--,--PROPERTY_'.$arProperty["TASK_PROJECT"].'--#--'.GetMessage("WZD_OPTION_228").'--,--PROPERTY_'.$arProperty["SHOW_ON_INDEX_PAGE"].'--#--'.GetMessage("WZD_OPTION_209").'--,--PROPERTY_'.$arProperty["FORM_ORDER"].'--#--'.GetMessage("WZD_OPTION_122").'--,--PROPERTY_'.$arProperty["FORM_QUESTION"].'--#--'.GetMessage("WZD_OPTION_20").'--,--PROPERTY_'.$arProperty["MAP"].'--#--'.GetMessage("WZD_OPTION_342").'--,--PROPERTY_'.$arProperty["INFO"].'--#--'.GetMessage("WZD_OPTION_343").'--,--PROPERTY_'.$arProperty["LINK_COMPANY"].'--#--'.GetMessage("WZD_OPTION_210").'--;--edit5--#--'.GetMessage("WZD_OPTION_32").'--,--PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_34").'--,--PREVIEW_TEXT--#--'.GetMessage("WZD_OPTION_36").'--;--edit6--#--'.GetMessage("WZD_OPTION_38").'--,--DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_40").'--,--PROPERTY_'.$arProperty["DOCUMENTS"].'--#--'.GetMessage("WZD_OPTION_30").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_42").'--;--cedit1--#--'.GetMessage("WZD_OPTION_94").'--,--PROPERTY_'.$arProperty["LINK_GOODS"].'--#--'.GetMessage("WZD_OPTION_26").'--,--PROPERTY_'.$arProperty["LINK_SERVICES"].'--#--'.GetMessage("WZD_OPTION_148").'--,--PROPERTY_'.$arProperty["LINK_SALE"].'--#--'.GetMessage("WZD_OPTION_270").'--,--PROPERTY_'.$arProperty["LINK_NEWS"].'--#--'.GetMessage("WZD_OPTION_269").'--,--PROPERTY_'.$arProperty["LINK_PROJECTS"].'--#--'.GetMessage("WZD_OPTION_271").'--,--PROPERTY_'.$arProperty["LINK_REVIEWS"].'--#--'.GetMessage("WZD_OPTION_272").'--,--PROPERTY_'.$arProperty["LINK_STAFF"].'--#--'.GetMessage("WZD_OPTION_273").'--,--PROPERTY_'.$arProperty["LINK_FAQ"].'--#--'.GetMessage("WZD_OPTION_274").'--,--PROPERTY_'.$arProperty["LINK_TIZERS"].'--#--'.GetMessage("WZD_OPTION_235").'--,--PROPERTY_'.$arProperty["LINK_STUDY"].'--#--'.GetMessage("WZD_OPTION_28").'--,--PROPERTY_'.$arProperty["LINK_ARTICLES"].'--#--'.GetMessage("WZD_OPTION_319").'--;--cedit3--#--'.GetMessage("WZD_OPTION_229").'--,--PROPERTY_'.$arProperty["PHOTOS"].'--#--'.GetMessage("WZD_OPTION_18").'--,--PROPERTY_'.$arProperty["GALLEY_BIG"].'--#--'.GetMessage("WZD_OPTION_230").'--;--cedit2--#--'.GetMessage("WZD_OPTION_199").'--,--PROPERTY_'.$arProperty["BNR_TOP"].'--#--'.GetMessage("WZD_OPTION_223").'--,--PROPERTY_'.$arProperty["BNR_TOP_IMG"].'--#--'.GetMessage("WZD_OPTION_224").'--,--PROPERTY_'.$arProperty["BNR_TOP_BG"].'--#--'.GetMessage("WZD_OPTION_225").'--,--PROPERTY_'.$arProperty["CODE_TEXT"].'--#--'.GetMessage("WZD_OPTION_226").'--,--cedit2_csection1--#--'.GetMessage("WZD_OPTION_325").'--,--PROPERTY_'.$arProperty["TOP_PICTURE"].'--#--'.GetMessage("WZD_OPTION_324").'--;--cedit4--#--'.GetMessage("WZD_OPTION_231").'--,--PROPERTY_'.$arProperty["ORDERER"].'--#--'.GetMessage("WZD_OPTION_232").'--,--PROPERTY_'.$arProperty["SITE"].'--#--'.GetMessage("WZD_OPTION_116").'--,--PROPERTY_'.$arProperty["DATA"].'--#--'.GetMessage("WZD_OPTION_233").'--,--PROPERTY_'.$arProperty["AUTHOR"].'--#--'.GetMessage("WZD_OPTION_234").'--,--LINKED_PROP--#--'.GetMessage("WZD_OPTION_98").'--;--edit14--#--'.GetMessage("WZD_OPTION_44").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_TITLE--#--'.GetMessage("WZD_OPTION_46").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_KEYWORDS--#--'.GetMessage("WZD_OPTION_48").'--,--IPROPERTY_TEMPLATES_ELEMENT_META_DESCRIPTION--#--'.GetMessage("WZD_OPTION_50").'--,--IPROPERTY_TEMPLATES_ELEMENT_PAGE_TITLE--#--'.GetMessage("WZD_OPTION_52").'--,--IPROPERTY_TEMPLATES_ELEMENTS_PREVIEW_PICTURE--#--'.GetMessage("WZD_OPTION_54").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_56").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_58").'--,--IPROPERTY_TEMPLATES_ELEMENT_PREVIEW_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_60").'--,--IPROPERTY_TEMPLATES_ELEMENTS_DETAIL_PICTURE--#--'.GetMessage("WZD_OPTION_62").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_ALT--#--'.GetMessage("WZD_OPTION_56").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_TITLE--#--'.GetMessage("WZD_OPTION_58").'--,--IPROPERTY_TEMPLATES_ELEMENT_DETAIL_PICTURE_FILE_NAME--#--'.GetMessage("WZD_OPTION_60").'--,--SEO_ADDITIONAL--#--'.GetMessage("WZD_OPTION_64").'--,--TAGS--#--'.GetMessage("WZD_OPTION_66").'--;--edit2--#--'.GetMessage("WZD_OPTION_68").'--,--SECTIONS--#--'.GetMessage("WZD_OPTION_68").'--;--;--',
	));
	// list user options
