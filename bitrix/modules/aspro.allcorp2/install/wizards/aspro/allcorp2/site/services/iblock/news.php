...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("list", "tbl_iblock_list_".md5($iblockTYPE.".".$iblockID), array(
		'columns' => 'NAME,PREVIEW_PICTURE,DETAIL_PICTURE,ACTIVE,SORT,PROPERTY_'.$arProperty["PERIOD"].',PROPERTY_'.$arProperty["LINK_REGION"].',ID', 'by' => 'timestamp_x', 'order' => 'desc', 'page_size' => '20',
	));
}
