...
{
	Option::set("aspro.allcorp2", "USE_BITRIX_FORM", 'Y', WIZARD_SITE_ID);
	Option::set("form", "SIMPLE", 'N');
}
else
	Option::set("aspro.allcorp2", "USE_BITRIX_FORM", 'N', WIZARD_SITE_ID);

Option::set("aspro.allcorp2", "ORDER_VIEW", 'N', WIZARD_SITE_ID);
Option::set("aspro.allcorp2", "ADV_SIDE", 'Y', WIZARD_SITE_ID);
Option::set("aspro.allcorp2", "FONT_STYLE", 10, WIZARD_SITE_ID);
Option::set("aspro.allcorp2", "SITE_INSTALLED", 'Y', WIZARD_SITE_ID);
