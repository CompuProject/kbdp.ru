...
$FORM_SID = "aspro_allcorp2_director_".WIZARD_SITE_ID;
...
if($db_res = CEventType::GetList(array("TYPE_ID" => "FORM_FILLING_".$FORM_SID))){ 
	...
	if(!$count){
		...
		$arFields = array("LID" => $lang, "EVENT_NAME" => "FORM_FILLING_".$FORM_SID, "NAME" => GetMessage("EVENT_NEW_DIRECTOR_NAME"), "DESCRIPTION" => GetMessage("EVENT_NEW_DIRECTOR_DESCRIPTION"));
...
$by = "id"; $order = "asc";
$arFields = array("ACTIVE" => "Y", "EVENT_NAME" => "FORM_FILLING_".$FORM_SID, "LID" => WIZARD_SITE_ID, "EMAIL_FROM" => $wizard->GetVar("siteEmail"), "EMAIL_TO" => "#EMAIL_RAW#", "SUBJECT" => GetMessage("NEW_DIRECTOR_EMAIL_SUBJECT"), "MESSAGE" => GetMessage("NEW_DIRECTOR_EMAIL_TEXT"), "BODY_TYPE" => "html");
...
if($form_id){
	...
	$arFields = array(
		"NAME"				=> GetMessage("DIRECTOR_FORM_NAME"),
		"SID"				=> $FORM_SID,
		"C_SORT"			=> 300,
		"BUTTON"			=> GetMessage("DIRECTOR_BUTTON_NAME"),
		"DESCRIPTION"		=> GetMessage("DIRECTOR_FORM_DESCRIPTION"),
		"DESCRIPTION_TYPE"	=> "text",
		"STAT_EVENT1"		=> "form",
		"STAT_EVENT2"		=> "",
		"arSITE"			=> $arFormSiteIDs,
		"arMENU"			=> array( "ru" => GetMessage("DIRECTOR_FORM_NAME") ),
		"arGROUP"			=> array( "2" => "10" ),
		"arMAIL_TEMPLATE"	=> $arEventMessageIDs
	);	
	...
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("DIRECTOR_FORM_QUESTION_1"), "TITLE_TYPE" => "text", "SID" => "NAME", "C_SORT" => 100, "ADDITIONAL" => "N", "REQUIRED" => "Y", "arANSWER" => $arANSWER);
	CFormField::Set($arFields);

	$arANSWER = array();
	$arANSWER[] = array("MESSAGE" => " ", "C_SORT" => 100, "ACTIVE" => "Y", "FIELD_TYPE" => "textarea", "FIELD_PARAM" => "");
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("DIRECTOR_FORM_QUESTION_2"), "TITLE_TYPE" => "text", "SID" => "TITLE", "C_SORT" => 200, "ADDITIONAL" => "N", "REQUIRED" => "Y", "arANSWER" => $arANSWER);
	CFormField::Set($arFields);

	$arANSWER = array();
	$arANSWER[] = array("MESSAGE" => " ", "C_SORT" => 100, "ACTIVE" => "Y", "FIELD_TYPE" => "textarea", "FIELD_PARAM" => "");
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("DIRECTOR_FORM_QUESTION_3"), "TITLE_TYPE" => "text", "SID" => "MESSAGE", "C_SORT" => 300, "ADDITIONAL" => "N", "REQUIRED" => "Y", "arANSWER" => $arANSWER);
	CFormField::Set($arFields);
...
/*Заменяем макросы*/
CWizardUtil::ReplaceMacros($bitrixTemplateDir."/header.php", array("DIRECTOR_FORM_ID" => $form_id));
?>