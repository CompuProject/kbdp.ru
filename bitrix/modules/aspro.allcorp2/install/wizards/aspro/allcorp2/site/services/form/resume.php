...
$FORM_SID = "aspro_allcorp2_resume_".WIZARD_SITE_ID;
...
if($db_res = CEventType::GetList(array("TYPE_ID" => "FORM_FILLING_".$FORM_SID))){ 
	...
	if(!$count){
		...
		$arFields = array("LID" => $lang, "EVENT_NAME" => "FORM_FILLING_".$FORM_SID, "NAME" => GetMessage("EVENT_NEW_RESUME_NAME"), "DESCRIPTION" => GetMessage("EVENT_NEW_RESUME_DESCRIPTION"));
...
$by = "id"; $order = "asc";
$arFields = array("ACTIVE" => "Y", "EVENT_NAME" => "FORM_FILLING_".$FORM_SID, "LID" => WIZARD_SITE_ID, "EMAIL_FROM" => $wizard->GetVar("siteEmail"), "EMAIL_TO" => "#EMAIL_RAW#", "SUBJECT" => GetMessage("NEW_RESUME_EMAIL_SUBJECT"), "MESSAGE" => GetMessage("NEW_RESUME_EMAIL_TEXT"), "BODY_TYPE" => "html");
...
if($form_id){
	...
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("RESUME_FORM_QUESTION_1"), "TITLE_TYPE" => "text", "SID" => "NAME", "C_SORT" => 100, "ADDITIONAL" => "N", "REQUIRED" => "Y", "arANSWER" => $arANSWER);
	...
	$arANSWER = array();
	$arANSWER[] = array("MESSAGE" => " ", "C_SORT" => 100, "ACTIVE" => "Y", "FIELD_TYPE" => "text", "FIELD_PARAM" => "");
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("RESUME_FORM_QUESTION_4"), "TITLE_TYPE" => "text", "SID" => "POST", "C_SORT" => 300, "ADDITIONAL" => "N", "REQUIRED" => "Y", "arANSWER" => $arANSWER);
	CFormField::Set($arFields);

	$arANSWER = array();
	$arANSWER[] = array("MESSAGE" => " ", "C_SORT" => 100, "ACTIVE" => "Y", "FIELD_TYPE" => "textarea", "FIELD_PARAM" => "");
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("RESUME_FORM_QUESTION_5"), "TITLE_TYPE" => "text", "SID" => "MESSAGE", "C_SORT" => 300, "ADDITIONAL" => "N", "REQUIRED" => "N", "arANSWER" => $arANSWER);
	CFormField::Set($arFields);

	$arANSWER = array();
	$arANSWER[] = array("MESSAGE" => " ", "C_SORT" => 100, "ACTIVE" => "Y", "FIELD_TYPE" => "file", "FIELD_PARAM" => "");
	$arFields = array("FORM_ID" => $form_id, "ACTIVE" => "Y", "TITLE" => GetMessage("RESUME_FORM_QUESTION_6"), "TITLE_TYPE" => "text", "SID" => "FILE", "C_SORT" => 300, "ADDITIONAL" => "N", "REQUIRED" => "N", "arANSWER" => $arANSWER);
	CFormField::Set($arFields);
