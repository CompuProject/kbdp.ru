...
$iblockTYPE = "aspro_allcorp2_regionality";
...
if(WIZARD_INSTALL_DEMO_DATA){
	...
	CUserOptions::SetOption("form", "form_element_".$iblockID, array(
		"tabs" => 'edit1--#--'.GetMessage("WZD_OPTION_328").'--,--ACTIVE--#--'.GetMessage("WZD_OPTION_2").'--,--NAME--#--'.GetMessage("WZD_OPTION_8").'--,--XML_ID--#--'.GetMessage("WZD_OPTION_12").'--,--SORT--#--'.GetMessage("WZD_OPTION_14").'--,--IBLOCK_ELEMENT_PROP_VALUE--#--'.GetMessage("WZD_OPTION_16").'--,--PROPERTY_'.$arProperty["DEFAULT"].'--#--'.GetMessage("WZD_OPTION_329").'--,--PROPERTY_'.$arProperty["MAIN_DOMAIN"].'--#--'.GetMessage("WZD_OPTION_330").'--,--PROPERTY_'.$arProperty["FAVORIT_LOCATION"].'--#--'.GetMessage("WZD_OPTION_323").'--,--PROPERTY_'.$arProperty["DOMAINS"].'--#--'.GetMessage("WZD_OPTION_331").'--;--cedit1--#--'.GetMessage("WZD_OPTION_336").'--,--PROPERTY_'.$arProperty["PHONES"].'--#--'.GetMessage("WZD_OPTION_337").'--,--PROPERTY_'.$arProperty["EMAIL"].'--#--'.GetMessage("WZD_OPTION_339").'--,--PROPERTY_'.$arProperty["ADDRESS"].'--#--'.GetMessage("WZD_OPTION_340").'--,--PROPERTY_'.$arProperty["SHCEDULE"].'--#--'.GetMessage("WZD_OPTION_341").'--,--DETAIL_TEXT--#--'.GetMessage("WZD_OPTION_338").'--;--cedit2--#--'.GetMessage("WZD_OPTION_332").'--,--PROPERTY_'.$arProperty["REGION_NAME_DECLINE_RP"].'--#--'.GetMessage("WZD_OPTION_333").'--,--PROPERTY_'.$arProperty["REGION_NAME_DECLINE_PP"].'--#--'.GetMessage("WZD_OPTION_335").'--,--PROPERTY_'.$arProperty["REGION_NAME_DECLINE_TP"].'--#--'.GetMessage("WZD_OPTION_334").'--;--;--',
	), "Y");
	// list user options
...
if($iblockID){
	...
	if(!file_exists($file_robots.'robots.txt'))
	{
		...
		foreach($arFile as $key => $str)
		{
			...
			if(strpos($str, "Sitemap" ) !== false && \Bitrix\Main\Loader::includeModule('seo'))
