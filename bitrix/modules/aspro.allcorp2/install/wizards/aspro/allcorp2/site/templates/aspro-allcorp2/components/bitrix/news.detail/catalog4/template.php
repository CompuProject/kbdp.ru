...
<div class="item ext_view vertical <?=($arResult['GALLERY'] ? '' : ' wg')?>" data-id="<?=$arResult['ID']?>"<?=($bOrderViewBasket ? ' data-item="'.$dataItem.'"' : '')?>>
	<?// element name?>
	...
	<div class="head<?=($arResult['GALLERY'] ? '' : ' wti')?>">
		<div class="row">
			...
			<div class="<?=($arResult['GALLERY'] ? 'col-md-4 col-sm-6' : 'col-md-12 col-sm-12');?>">
