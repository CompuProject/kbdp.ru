<?
$MESS['ALLCORP2_PAGE_TITLE'] = 'Генерация robots.txt';
...
$MESS["ALLCORP2_MODULE_ROBOTS_ERROR"] = "Включите региональность и выберите тип \"на поддоменах\" для возможности перегенерации robots.txt";
$MESS["ALLCORP2_MODULE_ROBOTS_INFO"] = "<p>При нажатии кнопки <b>\"Пересоздать robots.txt\"</b> будет скопирован основной файл <b>/robots.txt</b> в директорию <b>/aspro_regions/robots/</b> для каждого домена вида <b>robots_DOMAIN.txt</b> в которых будет заменён адрес сайта под каждый домен в директиве <b>Host</b></p><p>Также возможно пересоздать <b>robots.txt</b> только для конкретного домена по кнопке <b>\"Пересоздать\"</b></p>";
...
$MESS["ALLCORP2_MODULE_EDIT_ROBOTS"] = "Редактировать robots.txt";
$MESS["ALLCORP2_MODULE_GENERATE_ROBOTS"] = "Пересоздать robots.txt";
$MESS["ALLCORP2_MODULE_GENERATE_ROBOTS_SHORT"] = "Пересоздать";
?>