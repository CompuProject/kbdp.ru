...
<div class="row">
	<div class="col-md-6">
		...
		<div class="flexslider front navigation-vcenter hover inside" data-plugin-options='{"animation":"slide", "animationLoop": true, "maxItems": 1}'>
			<ul class="slides">
				<li>
					<img alt="" class="img-responsive" src="/images/inner1.jpg">
				</li>
				<li>
					<img alt="" class="img-responsive" src="/images/inner2.jpg">
				</li>
				<li>
					<img alt="" class="img-responsive" src="/images/inner3.jpg">
				</li>
			</ul>
		</div>
	</div>
